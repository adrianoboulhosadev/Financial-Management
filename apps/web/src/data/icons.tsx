/**
 * The product's icon set: Phosphor, at the REGULAR weight, with a filled twin
 * for the five tab bar destinations (a tab states that it is the current one by
 * filling in, which is the one thing the outline weight cannot say).
 *
 * The path data is copied from `@phosphor-icons/core` rather than pulled in as a
 * dependency, and it is the SAME data as `apps/mobile/src/data/icons.tsx`. That
 * is deliberate and it is what keeps the two apps honest: the web renders it as
 * inline SVG and the phone renders it through react-native-svg, but neither can
 * quietly end up with a different glyph, and neither ships an icon package.
 *
 * Every glyph is a solid fill in `currentColor` on a 256-unit canvas, so colour
 * is inherited from whatever is around it and size is one prop.
 */
export type IconProps = { className?: string; size?: number }

const Icon = ({ className = '', size = 20, d }: IconProps & { d: string[] }) => (
  <svg
    viewBox="0 0 256 256"
    width={size}
    height={size}
...
export const DashboardIcon = (props: IconProps) => <Icon {...props} d={DASHBOARD_D} />
...
export const DashboardFilledIcon = (props: IconProps) => <Icon {...props} d={DASHBOARDFILLED_D} />
...
export const TransactionsIcon = (props: IconProps) => <Icon {...props} d={TRANSACTIONS_D} />
...
export const TransactionsFilledIcon = (props: IconProps) => <Icon {...props} d={TRANSACTIONSFILLED_D} />
...
export const NotificationsIcon = (props: IconProps) => <Icon {...props} d={NOTIFICATIONS_D} />
...
export const NotificationsFilledIcon = (props: IconProps) => <Icon {...props} d={NOTIFICATIONSFILLED_D} />
...
export const IncomeIcon = (props: IconProps) => <Icon {...props} d={INCOME_D} />
...
export const IncomeFilledIcon = (props: IconProps) => <Icon {...props} d={INCOMEFILLED_D} />
...
export const MoreIcon = (props: IconProps) => <Icon {...props} d={MORE_D} />
...
export const MoreFilledIcon = (props: IconProps) => <Icon {...props} d={MOREFILLED_D} />
...
export const ChecklistIcon = (props: IconProps) => <Icon {...props} d={CHECKLIST_D} />
...
export const RecurrencesIcon = (props: IconProps) => <Icon {...props} d={RECURRENCES_D} />
...
export const InvestmentsIcon = (props: IconProps) => <Icon {...props} d={INVESTMENTS_D} />
...
export const BanksIcon = (props: IconProps) => <Icon {...props} d={BANKS_D} />
...
export const BudgetsIcon = (props: IconProps) => <Icon {...props} d={BUDGETS_D} />

const CATEGORIES_D = [
  'M104,40H56A16,16,0,0,0,40,56v48a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V56A16,16,0,0,0,104,40Zm0,64H56V56h48v48Zm96-64H152a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,64H152V56h48v48Zm-96,32H56a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V152A16,16,0,0,0,104,136Zm0,64H56V152h48v48Zm96-64H152a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V152A16,16,0,0,0,200,136Zm0,64H152V152h48v48Z',
]

export const CategoriesIcon = (props: IconProps) => <Icon {...props} d={CATEGORIES_D} />
...
export const EnvelopeIcon = (props: IconProps) => <Icon {...props} d={ENVELOPE_D} />
...
export const EnvelopeOpenIcon = (props: IconProps) => <Icon {...props} d={ENVELOPEOPEN_D} />
...
export const TrashIcon = (props: IconProps) => <Icon {...props} d={TRASH_D} />
...
export const LogoutIcon = (props: IconProps) => <Icon {...props} d={LOGOUT_D} />
...
export const EyeIcon = (props: IconProps) => <Icon {...props} d={EYE_D} />
...
export const EyeSlashIcon = (props: IconProps) => <Icon {...props} d={EYESLASH_D} />
...
export const PencilIcon = (props: IconProps) => <Icon {...props} d={PENCIL_D} />

const CLOSE_D = [
  'M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z',
]

export const CloseIcon = (props: IconProps) => <Icon {...props} d={CLOSE_D} />
...
export const CardIcon = (props: IconProps) => <Icon {...props} d={CARD_D} />
...
export const CalendarCheckIcon = (props: IconProps) => <Icon {...props} d={CALENDARCHECK_D} />
...
export const GearIcon = (props: IconProps) => <Icon {...props} d={GEAR_D} />
...
export const CheckIcon = (props: IconProps) => <Icon {...props} d={CHECK_D} />
...
export const ReceiptIcon = (props: IconProps) => <Icon {...props} d={RECEIPT_D} />
