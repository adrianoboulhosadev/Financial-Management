...
export function useChecklistPage() {
   ...
   * reason the screen is opened, and what is settled is the receipt. Two
   * blocks rather than one sorted list, so "is there anything left" is
   * answered by the first heading. */
