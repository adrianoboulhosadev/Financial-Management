...
/**
 * Queue and job names, shared with the producer (apps/backend). These literals
 * MUST match on both sides — BullMQ cannot warn you that a job is being pushed
 * to a queue nobody listens to, so the two copies are the contract.
 */
